...
declare -a targets=("qemux86-64" "porter" "raspberrypi2" "raspberrypi3" "minnowboard")
...
# bsp submodule layer
declare -A bsparr
bsparr+=( ["minnowboard"]="meta-intel" ["raspberrypi2"]="meta-raspberrypi" ["raspberrypi3"]="meta-raspberrypi" ["porter"]="meta-renesas" )
